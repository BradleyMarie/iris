      ...
      .WillOnce(
          ([&](const Ray& trace_ray, geometric_t minimum_distance,
            ...
            return &hit_allocator.Allocate(
                nullptr, 2.0, static_cast<geometric_t>(0.0), 3, 4, false);
          }));
  ...
  EXPECT_CALL(geom, Trace(_, -std::numeric_limits<geometric_t>::infinity(),
      ...
      .WillOnce(
          ([&](const Ray& trace_ray, geometric_t minimum_distance,
            ...
            return &hit_allocator.Allocate(
                nested_hit, 1.0, static_cast<geometric_t>(0.0), 2, 3, false);
          }));
  ...
  EXPECT_CALL(geom, Trace(_, 3.0, 10.0, Geometry::ANY_HIT, _))
      .WillOnce(
          ([&](const Ray& trace_ray, geometric_t minimum_distance,
            ...
            EXPECT_EQ(ray, trace_ray);
            return &hit_allocator.Allocate(
                nullptr, 4.0, static_cast<geometric_t>(1.0), 3, 4, false);
          }));
  ...
  EXPECT_CALL(geom, Trace(_, 2.0, 4.0, Geometry::ANY_HIT, _))
      .WillOnce(
          ([&](const Ray& trace_ray, geometric_t minimum_distance,
            ...
            EXPECT_EQ(ray, trace_ray);
            return &hit_allocator.Allocate(
                nullptr, 6.0, static_cast<geometric_t>(0.0), 3, 4, false);
          }));
      ...
      .WillOnce(
          ([&](const Ray& trace_ray, geometric_t minimum_distance,
            ...
            Hit* closest_hit = &hit_allocator.Allocate(
                nullptr, 3.0, static_cast<geometric_t>(0.0), 3, 4, false);
            return &hit_allocator.Allocate(
                closest_hit, 4.0, static_cast<geometric_t>(0.0), 3, 4, false);
          }));
      ...
      .WillOnce(
          ([&](const Ray& trace_ray, geometric_t minimum_distance,
            ...
            Hit* last_hit = &hit_allocator.Allocate(
                nullptr, 10.0, static_cast<geometric_t>(0.0), 3, 4, false);
            Hit* closest_hit = &hit_allocator.Allocate(
                last_hit, 3.0, static_cast<geometric_t>(0.0), 3, 4, false);
            return &hit_allocator.Allocate(
                closest_hit, 4.0, static_cast<geometric_t>(0.0), 3, 4, false);
          }));

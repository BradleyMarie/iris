...
TEST(HitArena, AllocateAndClear) {
  ...
  Hit& hit1 = arena.Allocate(&hit0, 2.0, 5.0, 3, 4, value, sizeof(value));
  ...
  Hit& hit2 = arena.Allocate(nullptr, 5.0, -9.0, 6, 7, &maxval, sizeof(maxval));
...
TEST(HitArena, SetGeometry) {
  ...
  Hit& hit1 = arena.Allocate(nullptr, 1.0, 3.0, 1, 2, nullptr, 0);
  ...
  Hit& hit2 = arena.Allocate(nullptr, 1.0, 3.0, 1, 2, nullptr, 0);
  ...
  Hit& hit3 = arena.Allocate(nullptr, 1.0, 3.0, 1, 2, nullptr, 0);
  ...
  Hit& hit4 = arena.Allocate(nullptr, 1.0, 3.0, 1, 2, nullptr, 0);

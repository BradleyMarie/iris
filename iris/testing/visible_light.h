#ifndef _IRIS_TESTING_VISIBLE_LIGHT_
#define _IRIS_TESTING_VISIBLE_LIGHT_
...
class VisibleLight final : public Light {
 public:
  VisibleLight();

  MOCK_METHOD((std::optional<SampleResult>), Sample,
              (const HitPoint&, Sampler&, VisibilityTester&,
               SpectralAllocator&),
              (const override));
...
#endif  // _IRIS_TESTING_VISIBLE_LIGHT_

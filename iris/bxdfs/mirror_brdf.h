#ifndef _IRIS_BXDFS_MIRROR_BXDF_
#define _IRIS_BXDFS_MIRROR_BXDF_
...
class MirrorBrdf final : public Bxdf {
 public:
  MirrorBrdf(const Reflector& reflector) noexcept : reflector_(reflector) {}
...
#endif  // _IRIS_BXDFS_MIRROR_BXDF_